//! References:
//! - Markdown: `docs/test-cases/h265_vps_parser_unittest/h265vpsparsertest--testsamplevps.md`
//! - C++: `test/h265_vps_parser_unittest.cc:21`
//! - Port note: Group 11 / Case 55
...
fn test_sample_vps() {
    ...
    assert_eq!(vps.layer_id_included_flag_size, 0);
