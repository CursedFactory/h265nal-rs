...
enum {
  ...
  H265NAL_DUMP_FLAG_ADD_OFFSET = 1u << 1,
  H265NAL_DUMP_FLAG_ADD_LENGTH = 1u << 2,
  H265NAL_DUMP_FLAG_ADD_PARSED_LENGTH = 1u << 3,
  H265NAL_DUMP_FLAG_ADD_CHECKSUM = 1u << 4,
  H265NAL_DUMP_FLAG_ADD_RESOLUTION = 1u << 5,
};
