# H265ProfileTierLevelParserTest.TestSampleValue

- Source: `test/h265_profile_tier_level_parser_unittest.cc:20`
- Macro: `TEST_F`
- API focus: `H265ProfileTierLevelParser::ParseProfileTierLevel`
- Intent: Validate `H265ProfileTierLevelParser::ParseProfileTierLevel` on a representative sample input.

## Inputs
- Inline byte buffer `buffer` (17 bytes)
