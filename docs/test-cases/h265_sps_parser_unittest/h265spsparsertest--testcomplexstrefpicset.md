# H265SpsParserTest.TestComplexStRefPicSet

- Source: `test/h265_sps_parser_unittest.cc:191`
- Macro: `TEST_F`
- API focus: `H265SpsParser::ParseSps`
- Intent: Validate `H265SpsParser::ParseSps` behavior for `TestComplexStRefPicSet`.

## Inputs
- Inline byte buffer `buffer` (46 bytes)
...
- ... plus 69 additional field/value checks in source assertions.
